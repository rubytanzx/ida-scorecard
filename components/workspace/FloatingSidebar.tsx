    ...
    >
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 4, width: "100%", alignItems: "center" }}>
          ...
          {/* Workspace icons */}
          <SidebarBtn icon={IconLayoutDashboard} label="Workspace" active={isWorkspace} onClick={() => router.push("/workspace/mexico-fy25")} />
          <SidebarBtn icon={IconBriefcase} label="Projects" active={isProjects} onClick={() => router.push("/projects")} />
        </div>
